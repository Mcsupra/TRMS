...
let addRow = function (myRequest) {
    ...
    reqIdCol.innerHTML = reqIdCol.innerHTML = `<a href="message/${myRequest.reqId}">`+myRequest.reqId+`</a>`;
    ...
    eventCostCol.innerHTML = `<a href="view-reimbursement/${myRequest.reqId}">$`+myRequest.event_cost+`</a>`;
    ...
    addDocsCol.innerHTML = `<a href="upload/${myRequest.reqId}">Upload</a>`;
